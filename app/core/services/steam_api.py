...
if __name__ == "__main__":
    ...
    async def demo() -> None:
        ...
        if not getenv("STEAM_API_KEY") or not steamid:
            print("Skipping demo: set STEAM_API_KEY and STEAM_ID in your environment to run.")
            return
        async with SteamWebApiClient() as api:
            ...
            badges = await api.get_badges(steamid)
            print("Badges keys:", list(badges.keys())[1:])
